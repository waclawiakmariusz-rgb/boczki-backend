...
module.exports = (db) => {
  ...
  router.post('/admin/help-kb/seed', requireAdmin, (req, res) => {
    ...
    const SEED = [
      ...
      // ── PORTFEL / ZADATKI ─────────────────────────────────────
      { category:'Klienci', keywords:'portfel klienta, zadatek, zadatki, przedpłata klienta, saldo klienta, konto klienta, sprawdz zadatki, ile zadatku', answer:'Portfel klienta to wbudowane konto z saldem. Klient wpłaca pieniądze z góry (np. zaliczkę) — przy kolejnych wizytach kwota może zostać pobrana z portfela zamiast gotówki.' },
      { category:'Klienci', keywords:'wpłata na portfel, dodaj zadatek, wpisz zadatek klienta, zasilij portfel, wpłacił zadatek, przyjmij zadatek', answer:'W karcie klienta kliknij <b>Portfel → + Wpłata</b>. Podaj kwotę i formę płatności. Każda operacja jest odnotowana w historii portfela.' },
      { category:'Klienci', keywords:'pobierz z portfela, użyj zadatku, płatność z portfela klienta, użyj zadatki, rozlicz zadatek', answer:'Przy kasowaniu wizyty wybierz formę płatności <b>Portfel</b>. System sprawdzi saldo i automatycznie pobierze odpowiednią kwotę. Możesz połączyć z gotówką (podziel płatność).' },
      { category:'Klienci', keywords:'historia portfela, operacje portfel, skąd to saldo, wszystkie wpłaty klienta, historia zadatków', answer:'Historia wszystkich wpłat i pobrań z portfela dostępna jest w zakładce <b>Portfel</b> w karcie klienta. Widać daty, kwoty i kto wykonał każdą operację.' },
      ...
      { category:'Ogólne', keywords:'cena estelio, ile kosztuje, abonament miesięczny, 79 zł, opłata miesięczna', answer:'Estelio kosztuje <b>79 zł miesięcznie</b>. Płatność kartą przez Stripe — odnawiana automatycznie. Pytania o fakturę lub anulowanie: <a href="mailto:kontakt@estelio.com.pl">kontakt@estelio.com.pl</a>' },
